...
var dishSpecs = map[string]DishSpecification{
	"DSS14": {
		Name:                      "DSS-14",
		Diameter:                  "70 meters",
		Type:                      "Azimuth-Elevation Cassegrain",
		BuiltIn:                   "1966 (extended to 70m in 1988)",
		TransmittersFrequency:     "S and X bands",
		ReceiversFrequency:        "S, X, L, K and Ka bands",
		TransmittersPower:         "20-400 kW",
		Precision:                 "0.006 degrees",
		TotalWeight:               "2700 tons",
		DishWeight:                "",
		...
		WebUrl:                    "https://www.gdscc.nasa.gov/index.php/antennas/",
		Location:                  "gdscc",
	},
	"DSS24": {
		Name:                      "DSS-24",
		...
		BuiltIn:                   "1994",
		TransmittersFrequency:     "S band",
		ReceiversFrequency:        "S, X, K and Ka bands",
	...
	"DSS25": {
		...
		Type:                      "Azimuth-Elevation Beam Wave Guide",
		BuiltIn:                   "1996",
		TransmittersFrequency:     "X and Ka bands",
		ReceiversFrequency:        "X and Ka bands",
		TransmittersPower:         "20 Kw (X-band), 800 W (Ka-band)",
		Precision:                 "0.004 degrees",
		TotalWeight:               "",
		DishWeight:                "",
		AntennaSpeed:              "0.8 degrees/s",
	...
	"DSS26": {
		...
		ReceiversFrequency:        "X, K and Ka bands",
		TransmittersPower:         "20 Kw (80 Kw high-power option)",
		Precision:                 "0.004 degrees",
		TotalWeight:               "",
		DishWeight:                "",
		AntennaSpeed:              "0.8 degrees/s",
